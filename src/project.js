      ...
      .then(() => {
        ...
        firestore
          ...
          .then((snapshot) => {
            ...
            document.getElementById("nextArrow").href =
              data[index < length ? index + 1 : 0];
  ...
  createClips = (item) => (
    <div>
      {item &&
        item.map((clip, index) => (
          <div
            key={this.state.postID + "clip" + index}
            className="clip"
    ...
    return (
      <div className="projectPage">
              ...
              <div className="information">
                <div>
                  ...
                  {this.state.data.Client && (
                    <p>
                      Client:{" "}
                      {this.state.data.ClientURL ? (
                        <a href={this.state.data.ClientURL}>
                          {this.state.data.Client}
                        </a>
                      ) : (
                        this.state.data.Client
                  ...
                  {this.state.data.FullProject && (
                    <p>
                      ...
                      <a href={this.state.data.FullProject}>here</a>
                    </p>
                  )}
        ...
        {sessionStorage.getItem("loggedIn") && (
          <div>
            <a href={"/edit/" + this.state.postID} className="linkButton">
              Edit
            </a>
            <button
              href={"/edit/" + this.state.postID}
