            ...
            <div className="upload">
                <form onSubmit={this.handleSubmit.bind(this)} method="POST">
                    ...
                    <div>
                        ...
                        <input type="text" id="uploadVideo" required name="Video" readOnly/>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="uploadCoverImage" autoComplete="off" required name="CoverImage" readOnly/>
                    </div>
                    ...
                    <div>
                        <div>
                            ...
                            <input type="text" className="form-control" id="uploadClient" name="Client"/>
                        </div>
                        <div>
